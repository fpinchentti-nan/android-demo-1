...
/**
 * Created by francisco on 21/04/15.
 */
public class DetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* TODO CUSTOM: */
        bookTitleTextView = (TextView) findViewById(R.id.bookTitle);
        bookAuthorTextView = (TextView) findViewById(R.id.bookAuthor);
        mBookAuthor = this.getIntent().getExtras().getString("bookAuthor");
        mBookTitle = this.getIntent().getExtras().getString("bookTitle");
        bookAuthorTextView.setText(mBookAuthor);
        bookTitleTextView.setText(mBookTitle);
